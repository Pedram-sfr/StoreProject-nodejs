...
const createProductSchema = Joi.object({
    ...
    // colors: Joi.array().allow().min(0).max(20).error(createError.BadRequest("رنگ های انتخابی  نمیتواند بیشتر از 20 ایتم باشد")),
    category: Joi.string().regex(RegExp(MongoIDPattern)).error(createError.BadRequest("دسته بندی مورد نظر یافت نشد")),
